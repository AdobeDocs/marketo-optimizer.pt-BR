...
>abstract="Use a habilidade Scoring Studio para criar, configurar e publicar modelos de pontuação de leads personalizados por meio da interface de chat do Coworker."
